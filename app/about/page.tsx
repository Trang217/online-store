 ...
 function AboutPage() {
  return (
    <section>
      ...
      <p className="mt-8 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero hic
